...
--dap
map("n", "<F6>", require("dap").step_back, "[DEBUG DAP] step_back")
map("n", "<F7>", require("dap").step_into, "[DEBUG DAP] step_into")
map("n", "<F8>", require("dap").step_over, "[DEBUG DAP] step_over")
map("n", "<F9>", require("dap").step_out, "[DEBUG DAP] step_out")
map("n", "<F11>", require("dap").continue, "[DEBUG DAP] continue")
map("n", "<F12>", require("dap").terminate, "[DEBUG DAP] terminate")
map("n", "<leader>dr", require("dap").repl.open, "[DEBUG DAP] repl open")
map("n", "<leader>db", require("dap").toggle_breakpoint, "[DEBUG DAP] toggle breakpoint")
map("n", "<leader>dB", function()
	require("dap").set_breakpoint(vim.fn.input("[DEBUG DAP] Condition > "), "[DAP] condition")
end, "breakpoint condition")
map("v", "<leader>de", require("dapui").eval, "[DEBUG DAPUI] eval")
map("n", "<leader>dE", function()
	require("dapui").eval(vim.fn.input("[DEBUG DAP] Expression > "), "[DAPUI] expression")
end)
map("n", "<leader>dT", "<cmd> lua require'dapui'.toggle()<cr>", "[DEBUG DAPUI] toggle")

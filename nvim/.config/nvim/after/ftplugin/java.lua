...
local path_jdtls = home .. "/.local/share/nvim/mason/packages/jdtls"
-- TODO: Testing
...
local config = {
    ...
    cmd = {
        ...
        "-Dlog.protocol=true",
        "-Dlog.level=ALL",
        "-javaagent:" .. path_jdtls .. "/lombok.jar",
        "-Xms1g",
        ...
        -- 💀
        "-jar",
        vim.fn.glob(path_jdtls .. "/plugins/org.eclipse.equinox.launcher_*.jar"),
        -- Must point to the                                                     Change this to
        -- eclipse.jdt.ls installation                                           the actual version

        -- 💀
        "-configuration",
        path_jdtls .. "/config_" .. CONFIG,
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
